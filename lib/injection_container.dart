...
Future<void> initializeDependencies() async {
  ...
  sl.registerSingleton<RealtimeWeatherRepository>(RealtimeWeatherRepositoryImpl(sl()));


  //UseCases

  sl.registerSingleton<FetchRealtimeWeatherUseCase>(FetchRealtimeWeatherUseCase(sl()));
